...
<div class="card-body">
    ...
    <div>
        <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ \App\Models\Project::count() }}</span></h4>
...
<div class="col-md-6 col-xl-3">
    ...
    <div class="card-body">
        ...
        <div>
            <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ \App\Models\ReadyProject::count() }}</span></h4>
...
<div class="col-md-6 col-xl-3">
    ...
    <div class="card-body">
        ...
        <div>
            <h4 class="mb-1 mt-1"><span data-plugin="counterup">{{ \App\Models\Ticket::count() }}</span></h4>
