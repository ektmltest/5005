    ...
    <aside class="aside-bar">
        <div class="faq-control">
            ...
            <ul class="list-unstyled" id="projectsStatus">
                <li class="active" id="0"><a href="javascript:;"><i class='bx bxs-grid'></i>{{ __('myprojects_trans.My projects') }}</a></li>
                <li id="1"><a href="javascript:;"><i class='bx bx-alarm'></i>{{ __('myprojects_trans.Await') }}</a></li>
                <li id="6"><a href="javascript:;"><i class='bx bx-check'></i>{{ __('myprojects_trans.Accepted') }}</a></li>
                <li id="7"><a href="javascript:;"><i class='bx bx-money'></i>{{ __('myprojects_trans.Awaiting payment') }}</a></li>
                <li id="2"><a href="javascript:;"><i class='bx bx-edit'></i>{{ __('myprojects_trans.Under implementation') }}</a></li>
                <li id="3"><a href="javascript:;"><i class='bx bx-check-double'></i>{{ __('myprojects_trans.Completed') }}</a></li>
                <li id="4"><a href="javascript:;"><i class='bx bx-package'></i>{{ __('myprojects_trans.Delivered') }}</a></li>
                <li id="5"><a href="javascript:;"><i class='bx bx-task-x'></i>{{ __('myprojects_trans.Canceled') }}</a></li>
                <li id="8"><a href="javascript:;"><i class='bx bx-x-circle'></i>{{ __('myprojects_trans.Rejected') }}</a></li>
            </ul>
        </div>
    </aside>
</div>
...
<div class="col-xl-9 col-lg-4">
    <div class="vacan-posts" id="projects">
        ...
        <h6>
            ...
            <div>
                <p class="msg text-center">{{ __('myprojects_trans.there is no Projects in this status') }}</p>
            </div>
            </a>
            </div>
        </h6>
