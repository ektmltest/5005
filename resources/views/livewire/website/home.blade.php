        ...
        <div class="head-content">
            <div class="row row-aligns">
                <div class="col-md-6 order-2 order-md-1">
                    <div class="head-txt">
                        <h2 class="h1">{{ __("main_trans.title1") }} <span
                                class="co-purple">{{ __("main_trans.title2") }}</span></h2>
                        ...
                        <div class="head-buttons">
                            ...
                            <a class="bttn btn-empty" href="https://www.youtube.com/watch?v=afj3WB44lko"
                                data-lity>{{ __('main_trans.Watch Video') }} <i class='bx bx-right-arrow'></i></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="txt-item">
            ...
            <div class="person-details">
                <div class="img-person">
                    <img width="640" height="360" class="img-fluid lazyload"
                        data-src="https://www.ektml.com/avatar/user/8" loading="lazy" alt="User profile avatar">
                </div>
...
<section id="download" class="download parallax my-5">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="img-phone">
                    <img class="img-fluid lazyload" src="https://www.ektml.com/static/img/our_app.webp" loading="lazy"
                        alt="Ektml mobile application">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="post-item">
                    ...
                    <div class="post-txt">
                        <a class="post-title" href="https://www.ektml.com/blog/31/imam-library">إكتمال برمجة موقع مكتبة
                        ...
                        <p>تعلن منصة إكتمل عن إكتمال برمجة مكتبة إمام الدعوة الرقميةوالذي يشرف عليهمعالي الشيخ \ عبد
                            الرحمن السديس إمام وخطيب الحرم المكي وبإذن الله سيتم تدشين الموقع في حفل يرئسةمعالي الشيخ \
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                <div class="form-buttons">
                                    <button type="submit"
                                        class="btn bttn btn-purple">{{ __('home_trans.Submit') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
