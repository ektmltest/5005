...
<form action="signin/enter" method="POST" name="signinForm" data-parsley-errors-container="#validerrors" novalidate="">
    <div class="row">
        <input type="hidden" name="reCAPTCHA" value="">
        <div class="col-xl-12">
            <div class="form-group">
                <div class="floating-label-wrap">
                    <input type="email" autocomplete="on" class="floating-label-field floating-label-field--s3"
        ...
        <div class="col-xl-12">
            <div class="form-group">
                <div class="floating-label-wrap">
                    <input type="password" class="floating-label-field floating-label-field--s3" id="field-2"
