                            ...
                            <form wire:submit.prevent="submit">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mt-3 mt-lg-0">
                                            ...
                                            <input dir="ltr" type="text" class="form-control" wire:model="name_en" value="{{$project->nameLocale('en')}}">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-6">
                                        <div class="mb-3 mt-3 mt-lg-0">
                                            ...
                                            <input dir="ltr" type="number" class="form-control" wire:model="price" value="{{$project->price}}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mt-3 mt-lg-0">
                                            ...
                                            <input dir="ltr" type="number" class="form-control" wire:model="tax" value="{{$project->marketing_discount_ratio}}">
                                        ...
                                        <div class="mb-3 mt-3 mt-lg-0">
                                            ...
                                            <div class="form-control p-0 border-0">
                                                <select wire:ignore class="js-example-basic-multiple w-100"
                                                    ...
                                                    <option value="{{$addon->id}}" @if($project->hasAddon($addon->id)) selected @endif>{{$addon->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="mb-3 mt-3 mt-lg-0">
                                            ...
                                            <div class="form-control p-0 border-0">
                                                <select wire:ignore class="js-example-basic-multiple w-100" name="facilities_ids" multiple="multiple" id=""
                                                    ...
                                                    <option value="{{$facility->id}}" @if($project->hasFacility($facility->id)) selected @endif>{{$facility->description}}
                                                    </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="mb-3 mt-3 mt-lg-0">
                                        ...
                                        <div class="form-control p-0 border-0">
                                            <select wire:ignore name="tags_ids" class="w-100 js-example-basic-multiple" multiple="multiple" id="" style="cursor: pointer">
                                                @foreach ($tags as $tag)
                                                <option value="{{$tag->id}}" @if($project->hasTag($tag->id)) selected @endif>{{$tag->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-6 mb-3 mt-3 mt-lg-0">
                                        ...
                                        <input class="form-control" type="file" oninput="topbar.show(); showSpinner('profile-image-spinner');" wire:model='image' />
