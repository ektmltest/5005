<div class="main-content">
                        ...
                        <div class="table-responsive mb-2">
                            <table class="table table-centered table-nowrap mb-0 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $platform->id }}</td>
                                        <td>{{ Str::limit($platform->name, 20, '...') }}</td>
                                        <td>{{ Str::limit($platform->link, 20, '...') }}</td>
                                        <td>{{ Str::limit($platform->user->full_name, 20, '...') }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-block" data-bs-toggle="tooltip" data-placement="top" title="{{__('dashboard_trans.SHOW')}}">
                                                <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#show_platform{{$platform->id}}"><i
                                                        class="fa fa-eye"></i></button>
                                            </div>

                                            <div class="d-inline-block" data-bs-toggle="tooltip" data-placement="top" title="{{__('dashboard_trans.DELETE')}}">
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    wire:click="deleteMode({{ $platform->id }})"><i
                                    ...
                                    <!-- show -->
                                    <div class="modal fade p-0" id="show_platform{{ $platform->id }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
                                        <div class="modal-dialog p-0">
                                            <div class="modal-content card border-0">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">{{
                                                        __('dashboard_trans.SHOW') . ' ' . __('dashboard_trans.Our platforms') . ": $platform->id" }}</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                {{-- <img class="card-img-top" src="{{$platform->image}}" alt="Card image cap"> --}}
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="pt-3 pb-3">{{$platform->nameLocale('ar')}}</div>
                                                        </div>

                                                        <div class="col-lg-6 mb-3">
                                                            <label for="message-text" class="text-primary col-form-label">{{
                                                                __('dashboard_trans.ENGLISH NAME') }}</label>
                                                            <div class="pt-3 pb-3">{{$platform->nameLocale('en')}}</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-3">
                                                            ...
                                                            <div class="pt-3 pb-3">{{$platform->icon}} <i class="{{$platform->icon}}"></i></div>
                                                        </div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="mb-3">
                                                            <label for="message-text" class="text-primary col-form-label">{{ __('dashboard_trans.LINK') }}</label>
                                                            <div class="pt-3 pb-3"><a href="{{$platform->link}}">{{$platform->link}}</a></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="pt-3 pb-3">{{$platform->user->full_name}}</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="pt-3 pb-3">{{Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $platform->created_at)->format('D d, M, Y g:i A')}}</div>
                                                        </div>
                                                    </div>
                                    ...
                                    <!-- delete -->
                                    <div class="modal fade" id="delete_platform{{ $platform->id }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="addPlatform">
                                <div class="row mt-4">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" wire:model="store.link">
                                            @error("store.link") <span class="error">{{ $message }}</span> @enderror
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        window.addEventListener('deleteMode', (e) => {
            $('#delete_platform'+e.detail.id).modal('show');
        })
    </script>
    @endpush
</div> <!-- container-fluid -->
