                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm" data-id=""
                                    data-bs-toggle="modal" data-bs-target="#edit_category"><i class="fa fa-edit"></i></button>

                                <button type="button" class="btn btn-danger btn-sm"
                                    data-bs-toggle="modal" data-bs-target="#delete_category"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                    </tbody>
                ...
                <form wire:submit.prevent="editCategory">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="ename_ar" value="" id="recipient-name">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="ename_en" value="" id="recipient-name">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="eicon" value="" id="recipient-name">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" wire:model="estart_price" value="" id="recipient-name">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="deleteCategory">
                        <div class="mb-3 text-center">
                            <input type="text" class="form-control hidden" value="" id="recipient-name">
