                            ...
                            <table class="table table-centered table-nowrap mb-0 text-center">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ Str::upper(__('dashboard_trans.Key')) }}</th>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="message-text" class="col-form-label">{{
                                                            __('dashboard_trans.Key') }}</label>
                                                        <input type="text" class="form-control"
                                                            wire:model="data.{{$type->id}}.key"
                                                            id="recipient-name">
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button class="btn btn-primary"
                                                            wire:click='editGalleryType({{$type->id}})'>{{
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button class="btn btn-danger"
                                                            wire:click='deleteGalleryType({{$type->id}})'>{{
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="addType">
                                ...
                                <div class="row mt-4">
                                    <div class="mb-3">
                                        <label class="form-label">{{ Str::upper(__('dashboard_trans.Key')) }}</label>
