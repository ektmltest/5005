                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form wire:submit.prevent="submit">
                                ...
                                <div class="row mt-4">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input dir="ltr" type="text" class="form-control"
                                                wire:model="new.title_ar">
                                            @error("new.title_ar") <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mt-3 mt-lg-0">
                                            ...
                                            <input dir="ltr" type="text" class="form-control"
                                                wire:model="new.title_en">
                                            @error('new.title_en') <span class="error">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button wire:loading.attr='disabled' onclick="topbar.show()" type="submit" class="btn btn-info">{{
