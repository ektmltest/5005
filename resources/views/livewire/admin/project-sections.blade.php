        ...
        <table class="table table-centered table-nowrap mb-0 text-center">
            <thead>
                <tr>
                    ...
                    <th>{{ __('dashboard_trans.Project Department') }}</th>
                    <th>{{ __('dashboard_trans.ACTION') }}</th>
                </tr>
            </thead>

            @foreach(\App\Models\ProjectCategory::paginate(5) as $category)
                <tbody>
                    <tr>
                        <td>{{ $category->id }}</td>
                        ...
                        <td>{{ $category->start_price }}</i></td>
                        <td>{{ $category->department->name }}</i></td>
                        <td>
                            <button type="button" class="btn btn-primary btn-sm" data-id="{{ $category->id }}"
                                data-bs-toggle="modal" data-bs-target="#edit_category{{ $category->id }}"><i class="fa fa-edit"></i></button>

                            <button type="button" class="btn btn-danger btn-sm"
                                data-bs-toggle="modal" data-bs-target="#delete_category{{$category->id}}"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                </tbody>
            ...
            <form wire:submit.prevent="editCategory({{$category->id}})">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" wire:model="ename_ar" value={{ $category->nameLocale('ar') }} id="recipient-name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" wire:model="ename_en" value={{ $category->nameLocale('en') }} id="recipient-name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" wire:model="eicon" value={{ $category->eicon }} id="recipient-name">
                        @error('eicon') <span class="error">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-3">
                        <label for="message-text" class="col-form-label">{{ __('dashboard_trans.START PRICE') }}</label>
                        <input type="number" class="form-control" wire:model="estart_price" value={{ $category->start_price }} id="recipient-name">
                        @error('estart_price') <span class="error">{{ $message }}</span> @enderror
                    </div>

                    <div class="mb-3">
                        <label for="message-text" class="col-form-label">{{ __('dashboard_trans.Project Department') }}</label>
                        <select wire:model="eproject_department_id" class="form-control">
                        ...
                        @error('eproject_department_id') <span class="error">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3 mt-3 mt-lg-0">
                                ...
                                @error("start_price") <span class="error">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">{{ __('dashboard_trans.Project Department') }}</label>
                                ...
                                @error("project_department_id") <span class="error">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3 mt-3 mt-lg-0">
                                ...
                                <button type="submit" class="btn btn-success form-control">{{ __('dashboard_trans.Add Category') }}</button>
                            </div>
                        </div>
