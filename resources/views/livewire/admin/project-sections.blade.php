            ...
            @foreach(\App\Models\ProjectDepartment::paginate(5) as $key => $deparment)
                <tbody>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-primary btn-sm" data-id="{{ $deparment->id }}"
                                data-bs-toggle="modal" data-bs-target="#edit_deparment{{ $deparment->id }}"><i class="fa fa-edit"></i></button>

                            <button type="button" class="btn btn-danger btn-sm"
                                data-bs-toggle="modal" data-bs-target="#delete_deparment{{$deparment->id}}"><i class="fa fa-trash"></i></button>
                        </td>
                    </tr>
                </tbody>

<!-- edit -->
<div class="modal fade" id="edit_deparment{{ $deparment->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form wire:submit.prevent="editDeparment({{$deparment->id}})">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name_ar" value={{ $deparment->nameLocale('ar') }} id="recipient-name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name_en" value={{ $deparment->nameLocale('en') }} id="recipient-name">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="icon" value={{ $deparment->icon }} id="recipient-name">
...
<!-- delete -->
<div class="modal fade" id="delete_deparment{{ $deparment->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="deleteDeparment({{$deparment->id}})">
                    <div class="mb-3 text-center">
                        <input type="text" class="form-control hidden" value={{ $deparment->id }} id="recipient-name">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3 mt-3 mt-lg-0">
                                ...
                                <button type="submit" class="btn btn-success form-control">{{ __('dashboard_trans.Add Section') }}</button>
                            </div>
                        </div>
