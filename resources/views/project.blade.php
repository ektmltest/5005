...
@section('title', ucwords(__('main_trans.app_name')) . ' - ' .  __(\App\Models\Project::find(request('id'))->name))
            ...
            <div class="box-inner">
                <div class="box-content">
                    <div class="page-title">
                        <h2 class="h1">{{ \App\Models\Project::find(request('id'))->name }}</h2>
                        <p>{{ \App\Models\Project::find(request('id'))->description }}</p>
                    </div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="https://www.ektml.com/">الرئيسة</a></li>
